...
import com.narcsoft.course.repositories.CategoryRepository;
import com.narcsoft.course.repositories.OrderItemRepository;
import com.narcsoft.course.repositories.OrderRepository;
import com.narcsoft.course.repositories.ProductRepository;
...
public class TesteConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		p1.getCategories().add(cat2);  // associação entre os objetos de muitos para muitos que criamos em product e category
